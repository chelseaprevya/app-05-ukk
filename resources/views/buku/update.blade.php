...
<div class="container">
    <div class="card">
        <div class="card-body">
            ...
            {{-- form action --}}
            <form action="{{ url('buku/'. $buku->id_buku) }}" method="POST" class="row-lg-3" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="deskripsi" name="deskripsi" value="{{ old('deskripsi', $buku->deskripsi) }}">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="stok" name="stok" value="{{ old('stok', $buku->stok) }}">
                </div>
                <div class="mb-3">
                    <label for="genre" class="form-label">Genre</label>
                    <select class="form-select form-select-sm" aria-label=".form-select-sm example" id="genre" name="genre" value="{{ old('genre', $buku->genre) }}">
